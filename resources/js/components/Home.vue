        ...
        <v-container fluid>
            <v-row>
                <v-col cols="12" lg="6" md="6" class="pa-0">
                    <v-img src="../image/back.jpg" :aspect-ratio="16/16">
                    ...
                    <v-container fluid>
                        <v-row justify="center" style="margin-top:10%">
                            <v-col cols="6" align="center">
                                <v-img src="../image/logo.png" style="max-width:500px;height:auto"></v-img>
                            </v-col>
                        </v-row>
                        <v-row justify="center">
                            <v-col align="center">
                                ...
                                <p class="caption">Subscribe to get notificatio as soon as we launch!</p>
